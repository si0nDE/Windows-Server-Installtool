...
### Startbildschirm ###
    function startbildschirm {
        Write-Host "╔══════════════════════════════════════════════════════════════════════════════╗"
        Write-Host "║ Windows Server-Manager Tool v2.0.10αs                                        ║"
        Write-Host "║                                                                              ║"
        Write-Host "╚══════════════════════════════════════════════════════════════════════════════╝"
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvhav+pGCBW8gBZfqGOyobK7Q
# XpCggg28MIIGuTCCBKGgAwIBAgIRAJmjgAomVTtlq9xuhKaz6jkwDQYJKoZIhvcN
...
# hvcNAQkEMRYEFJw4oMDIBINVae1tUn+VyZfMrD0QMA0GCSqGSIb3DQEBAQUABIIC
# AOGMXRdD3Wwe+fclvOLZR/1vXtwUsx9RylHIL3LNOvO4xSljIHbLSTH9tnWkOBMG
# Lcit0nBlyAKXiFr3lR9XdK/JPp7FhY+lferhQrYOzHtEpJZE0qHqMcaV82VjXSND
# pFk7w9ZYnGQ4Lh8akqx2mEWoyNDeuvCljIrK8vtGj1V4b4bPSc7P9JbXrk2k40on
# +U+epra7SCPZNpY8S+JXfORJKf4LAHiUOk8xeIhThqA3WyGy82hp/OreH+og9fnb
# qGDmD/m+TZegu00Uufb3IUjX7le673AeChXm63FuP1uSmFFCDqjdIbZFNrGfcb4k
# XYup8cdczduel7tcvg4W2pyh2CEhFWPLu8XHoY2C19N7Pjn7Zo410H5n8EyWd3nW
# d+1AJttKGZyVfNfIJ7h9FLDc97oLrDWw0Ycg/oQOA/2vA/D2LudEqM+JdkMpeiLr
# XY8+TB5dEKJ+PeJLMM4NTUmTu/xoDTBfi4UM7yXoF1KKhaRNc6aVjAwVAfuAQdLr
# kunloa50VVhOd5EiefAXujiAvsj4lbvP+RDqCZ4d2P9k7mb0vxKQu4i2cBZarT7E
# Y4RHn+BMhpXCCf5tmCW4wGwYu2k6fKQazPFuVwRFUcgqiyEh1rmsQI46+RCxNrv+
# nm6SEpT3xqtRrhCoBho8yGgRmqGyZUzil2X1eHdjD6Hr
