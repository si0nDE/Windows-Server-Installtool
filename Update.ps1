...
function Get-Update {
    ...
    Remove-Item "$installpath\Windows-Server-Installtool-master\Update.ps1"
    ...
    Move-Item "$installpath\Windows-Server-Installtool-master\scripts\*" "$installpath\scripts\" -Force
